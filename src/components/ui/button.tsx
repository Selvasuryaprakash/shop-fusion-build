  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        // Shopping-specific variants
        cart: "bg-gradient-accent text-accent-foreground hover:shadow-md transform hover:scale-105 transition-bounce font-semibold",
        hero: "bg-gradient-primary text-primary-foreground hover:shadow-lg transform hover:scale-105 transition-bounce text-base font-semibold",
        product: "bg-background text-foreground border border-border hover:bg-gradient-card hover:shadow-md transition-smooth",
